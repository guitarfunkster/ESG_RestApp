...
namespace ESG_ConsoleApp
{
    public class Program
    {
        ...
        //public static string CreateDefaultFile()
        //{
        //    const string DefaultFileName = "Esg_TestData.csv";

        //    var currentDir = Directory.GetCurrentDirectory();
        //    Console.WriteLine($"Missing input file. Looking for default file: {DefaultFileName} in dir: {currentDir}");
        //    var filePath = currentDir + DefaultFileName;
    ...
    public class Customer
    {
        ...
        //{
        //    return $"Customer: ref: {this.CustomerRef} name : {this.CustomerName} Address Line 1:{this.AddressLine1} ";
        //}
